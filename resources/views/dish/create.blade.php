<!DOCTYPE html>
    ...
    @include('shared.head', ['pageTitle' => 'Create a new dish'])
    ...
    <body class="d-flex flex-column min-vh-100">
        ...
        <div class="container mt-5 mb-5">
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-6">
                    <form method="POST" action="{{ route('dish.store') }}" class="needs-validation" novalidate>
                        @csrf
                        <div class="form-group mb-2">
                            <label for="dish_name" class="form-label">Dish name</label>
                            <input id="dish_name" name="dish_name" type="text" class="form-control @if ($errors->first('dish_name')) is-invalid @endif" value="{{ old('dish_name')}}">
                            <div class="invalid-feedback">Wrong dish name!</div>
                        </div>
                        <div class="form-group mb-2">
                            <label for="restaurant_name" class="form-label">Restaurant name</label>
                            <input id="restaurant_name" name="restaurant_name" type="text" class="form-control @if ($errors->first('restaurant_name')) is-invalid @endif" value="{{ old('restaurant_name')}}">
